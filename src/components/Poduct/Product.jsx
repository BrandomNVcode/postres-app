...
export const Product = ({item}) => {
  ...
  return (
    <div key={item?.id}
         className="w-275 h-[175px] min-w-[275px] md:w-300 md:min-w-[300px] z-0  bg-cardOverlay rounded-lg py-2 px-4  my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative">
      ...
      <div className="w-full flex flex-col items-end justify-end -mt-8 z-20">
        <p className="text-black font-semibold text-base md:text-lg">{item?.title}</p>
