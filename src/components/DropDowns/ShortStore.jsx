    ...
    return (
        <div className="relative inline-block text-left">
...

            {
                visible
                &&
                <div className="absolute right-0 z-10 mt-2 w-96 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="flex flex-col justify-center items-center" role="none">
                        <ItemShortStore drop={true}/>
                        <ItemShortStore drop={true}/>
                    </div>
